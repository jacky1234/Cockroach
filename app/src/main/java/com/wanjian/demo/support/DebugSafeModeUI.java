...
public class DebugSafeModeUI {
    ...
    private static List<WeakReference<Activity>> sActivitiesWRef = new ArrayList<>();
    ...
    public static void init(Application application) {
        application.registerActivityLifecycleCallbacks(new ActivityLifecycleCallbacksAdapter() {
            ...
            public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
                ...
                sActivitiesWRef.add(new WeakReference<>(activity));
            ...
            public void onActivityDestroyed(Activity activity) {
                ...
                for (WeakReference<Activity> reference : sActivitiesWRef) {
                    Activity act = reference.get();
                    if (act == activity) {
                        sActivitiesWRef.remove(reference);
                        return;
                    }
                }
            }
